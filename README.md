...
Сервис уведомлений потребляет событие и отправляет сообщение в ваш Telegram-чат.
...
- **Сырой SQL через `pg`** (без ORM) — соответствует заявленному в задании направлению на Postgres.
